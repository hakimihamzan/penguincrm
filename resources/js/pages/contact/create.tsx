            ...
            <div className="mx-auto md:w-2xl w-full px-4 py-8 md:px-6 lg:px-8">
                <div className="mb-8 flex items-center">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Add a new contact to your address book</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Enter the details for the new contact below.</CardDescription>
                    </CardHeader>
...
CreateContact.layout = (page: React.ReactNode) => <Layout>{page}</Layout>;
